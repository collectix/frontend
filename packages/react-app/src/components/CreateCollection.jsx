...
export default class CreateCollection extends React.Component {
    ...
    handleSubmit = event => {
        ...
        console.log(this.state.name, this.state.collection, this.state.categories, this.state.hashtag,
            this.state.deadline,  this.state.reward, this.state.description)
        ...
        return (
            ...
            >
                ...
                <form onSubmit={this.handleSubmit} style={{marginTop:'10px'}}>
                    ...
                    <label>
                        <TextField  style={{display:"block", marginTop:"15px"}} label="Collection" select value={this.state.collection} onChange={this.handleChangeCollection}>
                    ...
                    <label>
                        <TextField style={{display:"block", marginTop:"15px"}} label="Categories" type="text" value={this.state.categories} onChange={this.handleChangeCategories} />
                    </label>
                    <label>
                        <TextField style={{display:"block", marginTop:"15px"}} label="Hashtag" type="text" value={this.state.hashtag} onChange={this.handleChangeHashtag} />
                    </label>
                    <label>
                        <TextField style={{display:"block", marginTop:"15px"}} label="Deadline" type="text" value={this.state.deadline} onChange={this.handleChangeDeadline} />
                    </label>
                    <label>
                        <TextField style={{display:"block", marginTop:"15px"}} label="Reward" type="text" value={this.state.reaward} onChange={this.handleChangeReward} />
                    </label>
                    <label>
                        <TextField style={{display:"block", marginTop:"15px"}} label="Description" type="text" value={this.state.description} onChange={this.handleChangeDescription} />
                    </label>
